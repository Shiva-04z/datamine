...
class LinearRegressionTrainingView extends GetView<LinearRegressionController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text("Linear Regression Training",style: TextStyle(color: Colors.white),),
      ),
    ...
    Get.defaultDialog(
      ...
      content: SingleChildScrollView(
        child: Wrap(
          children:[ Column(
            children: [
              Text("Enter the detailes" ,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
              SizedBox(
                height: 20,
              ),
              Container(
