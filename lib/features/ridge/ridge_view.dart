...
import 'ridge_controller.dart';

class RidgeRegressionTrainingView extends GetView<RidgeRegressionController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text("Ridge Regression Training",style: TextStyle(color: Colors.white),),
      ),
          ...
          child: Obx(() => Column(
            ...
            children: [
              ...
              TextField(
                ...
                style: TextStyle(color: Colors.white),
                decoration: InputDecoration(
                    labelText: "L2 Regularization (Lambda)",
                    border: OutlineInputBorder(
                        borderSide: BorderSide(color: Colors.white))),
                keyboardType: TextInputType.number,
              ),
